...
#### The goal of this project is to show an understanding of arrays and loops
#### By _**{David Butler}**_
...
* Clone repository @ [Click here](https://github.com/davidabutler92/word-puzzle.git)
* Open word-puzzle (code .) in terminal.
* To see on gh-pages [Click here](https://davidabutler92.github.io/word-puzzle/)  
* 
